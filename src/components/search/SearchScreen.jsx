...
const SearchScreen = ({ products, attributes, categories, currency }) => {
  ...
  return (
    <div className="mx-auto max-w-screen-2xl px-3 sm:px-10 min-h-screen">
      <div className="flex py-2 lg:py-12">
        <div className="flex w-full">
          <div className="w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-6 gap-2 md:gap-3 lg:gap-3">
